# 0x16. C - Simple Shell
### Introduction
This repository is a [ALX](https://www.alxafrica.com/) Project. The school project consisted in writing a shell like sh (Bourne Shell) by Stephen Bourne  , in **C**, using a limited number of standard library functions, So Instead we used ower own function that we rewrited over the past three month [Here](https://github.com/youssefelzedy/holbertonschool-low_level_programming/)
...
`` git clone https://github.com/youssefelzedy/simple_shell ``
...
## Authors
* Youssef Megahed  [Theemiss](https://github.com/Bor3y9)
